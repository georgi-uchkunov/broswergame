...
public class TrainingRest {
	...
	public Training training(@RequestParam(name ="title") String title, @RequestParam(name="trainingTime") int trainingTime,
			@RequestParam(name="trainingSkill") String trainingSkill, @RequestParam(name="trainingDifficulty") String trainingDifficulty, @RequestParam(name="trainingCost") int trainingCost,
